...
const VIEW_ILLUS = {
  intro: `<svg viewBox="0 0 220 112" width="100%" height="100%" preserveAspectRatio="xMidYMid meet" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="180" cy="56" r="22" fill="#4a7c3f" fill-opacity="0.10"/><path d="M28 40 C 88 40, 124 56, 160 56" stroke="#b5894a" stroke-width="4" stroke-linecap="round"/><path d="M28 56 L 160 56" stroke="#a4423a" stroke-width="4" stroke-linecap="round"/><path d="M28 72 C 88 72, 124 56, 160 56" stroke="#3e6792" stroke-width="4" stroke-linecap="round"/><circle cx="28" cy="40" r="4.5" fill="#b5894a"/><circle cx="28" cy="56" r="4.5" fill="#a4423a"/><circle cx="28" cy="72" r="4.5" fill="#3e6792"/><g stroke="#4a7c3f" stroke-width="5" stroke-linecap="round"><line x1="180" y1="40" x2="180" y2="78"/><line x1="167" y1="52" x2="193" y2="52"/></g></svg>`,
...
function HomeScreen({ sessions, themes, onNavigate, onStartTour, onContinue, onOpenJournal }) {
  ...
  return (/*#__PURE__*/
    ...
    React.createElement(ViewIllus, { name: "intro" }), /*#__PURE__*/
